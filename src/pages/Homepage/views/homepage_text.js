...
export const homepageText = {
  fr: {
    ...
    homepageIntroSummary:
      "Bienvenue sur mon site web personnel.<br /> Diverses pages vous sont ici proposées, vous y trouverez mon CV en français et en anglais, ainsi que mon portfolio dans les deux langues également.<br /> Mais avant tout, qui suis-je?",
    homepageIntroIntroduction: `Je m'appelle Jonathan Binot, j'ai <span id="age">${age}</span> ans et je
...
moteurs de jeu modernes.`,
    homepageIntroObjectivesWeb: `Pour ce qui est du développement web, j'ai découvert cette discipline lors
...
page. Bonne visite.`,
  ...
  en: {
    ...
    homepageIntroSummary:
      "Welcome to my personnal website<br /> Different pages are available here, you will find my resume in English and in French, as well as my portfolio in the two languages too.<br /> But before anything else, who am I?",
    homepageIntroIntroduction: `My name is Jonathan Binot, I'm <span id="age">${age}</span> year old and I
    ...
    homepageIntroObjectivesWeb: `As for web development, I discovered this discipline during my first year of
